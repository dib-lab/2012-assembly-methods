...
\begin{figure}[ht]
\center{\includegraphics[scale=0.8]{coverage1.pdf}}
...
\begin{figure}[ht]
\center{\includegraphics[scale=0.8]{coverage2.pdf}}
\caption{Coverage of reference genomes by unfiltered and filtered
  assembled contigs and unfiltered and filtered reads.}
\label{coverage2}
\end{figure}
...
\begin{figure}[ht]
\center{\includegraphics[scale=0.5]{contig-lengths.pdf}}
...
\begin{figure}[ht]
\center{\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{ref_gi32470572.pdf}}
...
\begin{figure}[ht]
\center{\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{ecoli-multi-genomes.pdf}}
...
\begin{figure}[ht]
\center{\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{memory.pdf}}
...
\begin{figure}[ht]
\center{\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{corn.pdf}}
...
\begin{figure}[ht]
\center{\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{prairie.pdf}}
\caption{The presence of polymorphic sequences in assembled contigs of
