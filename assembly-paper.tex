...
do not scale to extremely large samples (cite Chain review?).
% @CTB cite?
...
% @CTB do we want to comment on this as a surprise?
...
the the described filtered assembly (Figure \cite{flowchart}; see Methods and
...
obtained with other assemblers (SOAPdenovo and Meta-IDBA).  Overall,
% @CTB reference the SOAPdenovo and Meta-IDBA results?
...
these datasets to a coverage threshold of 20.
% @CTB I don't understand this statement ^^
